...
def enviar_email(df):
    if not is_windows:
        st.warning("Este recurso está sendo simulado, pois o sistema operacional não é Windows.")
        return
        ...
        for dicts in infos:
            ...
            if confirmacao == '1':
                try:
                    ...
                    <li class=MsoNormal style='color:#242424;mso-margin-top-alt:auto;mso-margin-bottom-alt:auto;background:white'><i><span style='font-size:11.5pt;font-family:"Segoe UI",sans-serif;mso-ligatures:none;mso-fareast-language:PT-BR'>e-mail (parte):<o:p></o:p></span></i></li>
                    <li class=MsoNormal style='color:#242424;mso-margin-top-alt:auto;mso-margin-bottom-alt:auto;background:white'><i><span style='font-size:11.5pt;font-family:"Segoe UI",sans-serif;color:#242424;mso-ligatures:none;mso-fareast-language:PT-BR'>Quantidade de voucher(s):<o:p></o:p></span></i></li>
                    </ul>
